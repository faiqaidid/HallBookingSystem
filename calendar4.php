...
function build_calendar($month,$year){
	...
	while($currentDay <= $numberDays){
        ...
        elseif (in_array($date,$booking)) {
        	...
        	$calendar.="<td class='$today'><h4>$currentDay</h4><a href ='bookingform4.php?date=".$date."' class='btn btn-success btn-xs' 'class='open-button''>Book</a>";
        }
