			...
			<div class="uk-container">
				<div data-uk-grid>
					...
					<div class="uk-width-3-4@xl uk-width-3-4@l uk-width-3-4@m uk-width-1-1@s uk-margin-small-top">
						...
						<div class="impx-room-slider">
							<div class="uk-position-relative" data-uk-slideshow="animation: fade">
							    <ul class="uk-slideshow-items">
							        <li>
							            <img src="images/Hall-GoldCoast/hall-detail-1.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-GoldCoast/hall-detail-2.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-GoldCoast/hall-detail-3.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-GoldCoast/hall-detail-4.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-GoldCoast/hall-detail-5.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							    </ul>
							    ...
							    <div class="uk-position-bottom-center uk-position-medium">
							        <ul class="uk-thumbnav">
							            <li data-uk-slideshow-item="0"><a href="#"><img src="images/Hall-GoldCoast/hall-detail-1.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="1"><a href="#"><img src="images/Hall-GoldCoast/hall-detail-2.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="2"><a href="#"><img src="images/Hall-GoldCoast/hall-detail-3.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="3"><a href="#"><img src="images/Hall-GoldCoast/hall-detail-4.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="4"><a href="#"><img src="images/Hall-GoldCoast/hall-detail-5.jpg" width="100" alt=""></a></li>
							        </ul>
							    </div>
						...
						<p class="impx-text-large uk-margin-medium-bottom">Located on level 1 of the hotel, the Grand Ballroom is the largest conference and event space at Sofitel Gold Coast Broadbeach with seating up to 350 guests theatre style.</p>
						...
						<ul class="uk-switcher impx-room-tabs-content bg-color-white uk-box-shadow-medium">
						    <li><!-- tab content #1 -->
						    	...
						    	<p class="uk-margin-medium-bottom">Featuring a 10.5m LED screen, the state-of-the-art ultra-wide screen is over three times larger than a traditional projection screen and displays high resolution imagery, and 4K video accompanied by crystal clear sound. With ceilings 4.5m high and 312m² of floor space, this unique event space is ideal for magnificent dinner events, conferences or exhibitions.</p>
						     ...
						     <li><!-- tab content #3 (booking form) -->
						    	...
						    	<div class="impx-hp-booking-form side-form normal uk-margin-bottom">		
									    <div>
									        ...
									        <button class="uk-button uk-width-1-1"><a href="calendar.php"> Book Now! </a></button>
									    </div>
								</div>
