			...
			<div class="uk-container">
				<div data-uk-grid>
					...
					<div class="uk-width-3-4@xl uk-width-3-4@l uk-width-3-4@m uk-width-1-1@s uk-margin-small-top">
						...
						<div class="impx-room-slider">
							<div class="uk-position-relative" data-uk-slideshow="animation: fade">
							    <ul class="uk-slideshow-items">
							        <li>
							            <img src="images/Hall-Mitc/hall-detail-1.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-Mitc/hall-detail-2.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-Mitc/hall-detail-3.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-Mitc/hall-detail-4.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
							            <img src="images/Hall-Mitc/hall-detail-5.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							    </ul>
							    ...
							    <div class="uk-position-bottom-center uk-position-medium">
							        <ul class="uk-thumbnav">
							            <li data-uk-slideshow-item="0"><a href="#"><img src="images/Hall-Mitc/hall-detail-1.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="1"><a href="#"><img src="images/Hall-Mitc/hall-detail-2.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="2"><a href="#"><img src="images/Hall-Mitc/hall-detail-3.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="3"><a href="#"><img src="images/Hall-Mitc/hall-detail-4.jpg" width="100" alt=""></a></li>
							            <li data-uk-slideshow-item="4"><a href="#"><img src="images/Hall-Mitc/hall-detail-5.jpg" width="100" alt=""></a></li>
							        </ul>
							    </div>
						...
						<p class="impx-text-large uk-margin-medium-bottom">The Grand Ballroom is a pillar free space with crimson carpet located on Level 2 and complimented with a spacious foyer ; a sheer grandeur which encapsulates elegant surroundings and an aura of elegance for wedding receptions, annual dinners, birthday parties and other special or private events.</p>
						...
						<ul class="uk-switcher impx-room-tabs-content bg-color-white uk-box-shadow-medium">
						    <li><!-- tab content #1 -->
						    	...
						    	<p class="uk-margin-medium-bottom">A classical and elegant banquet room with a high ceiling and having a total floor dimension of 51m x 25.5m x 4.5m is able to house up to a maximum of 750 people for banquet seating at any one time.</p>
						     ...
						     <li><!-- tab content #3 (booking form) -->
						    	...
						    	<div class="impx-hp-booking-form side-form normal uk-margin-bottom">		
									    <div>
									        ...
									        <button class="uk-button uk-width-1-1"><a href="calendar2.php"> Book Now! </a></button>
									    </div>
								</div>
